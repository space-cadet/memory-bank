...
| T19 | Memory Bank Viewer Web Interface | 🔄 | HIGH | 2025-11-10 | - | [Details](tasks/T19.md) - Modular SPA; canonicalized into memory-bank/database with server-side pagination/filter/sort (2025-12-13). Ready for Phase 3 (Writes). |
