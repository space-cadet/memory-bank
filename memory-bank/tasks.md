...
| T13 | Implement Memory Bank CLI | 🔄 | HIGH | 2025-05-17 | T12 | [Details](tasks/T13.md) - Init command 100% complete, init.js refactored for code quality, timestamp utility extracted, content generators refactored |
...
| T3 | Implement DB Migration | 🔄 | HIGH | 2025-04-15 | T2 | [Details](tasks/T3.md) - Enhanced CLI: fixed package.json, added README files, detection checks, IST timestamps |
