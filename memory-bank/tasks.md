...
|----|-------|--------|----------|---------|--------------|---------|
| T24 | Migrate from better-sqlite3 to sql.js | 🔄 | HIGH | 2025-12-16 | T19, T21, T13 | [Details](tasks/T24.md) - Replace native addon with WASM SQLite for zero-friction installation |
