...
**Prerelease publication (2026-08-14):**
...
- ✅ Verified the packed artifact's Markdown-first and optional database workflows in clean temporary consumers
- ✅ Published and accepted `@space-cadet/memory-bank@0.1.0-beta.1`
- ✅ Updated GitHub Actions to Node 24-compatible action runtimes; run `31787276322` passed
- 🔄 Gather prerelease feedback and prepare the first stable release
- ⬜ Resolve npm `latest` dist-tag permissions before stable publication
