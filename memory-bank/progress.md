...
- ✅ Inventoried the fixture and defined the loss-aware event envelope
- ✅ Added a read-only importer and coverage report; two fixture imports matched exactly
- ✅ Added observed task-link and decision events plus retry/conflict tests
- ✅ Generated byte-stable Markdown views and exact record-event round trips
- ✅ Tested independent updates, retries, conflicts, and immutable event writes

**Outcome**: Revise before production use: immutable event files are promising;
shared JSONL must remain an export, not an authority.
...
- Event-backed coordination experiment (T28) - complete; revision recommended before adoption
...
- [x] Complete T28a fixture inventory and file-level import coverage report
- [x] Complete T28a relationship and decision extraction
- [x] Complete T28b deterministic projection and semantic round trip
- [x] Complete T28c concurrency and conflict simulation
