...
/**
 * Import: tasks.md -> task_items + task_dependencies
 */
...
app.post('/api/import/sessions/run', async (req, res) => {
  try {
    ...
    // Not using sqlite.transaction here because we need async file IO per file.
...
/**
 * Import: session_cache.md -> session_cache
 */
